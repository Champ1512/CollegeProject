...
if(isset($_POST['submit'])){
	...
	$register_query = "INSERT INTO `users`(`firstname`,`lastname`,`area`,`age`,`gender`,`bloodtype`, `phonenumber`, `email`, `username`, `password`) VALUES ('$firstname','$lastname','$area','$age','$gender','$bloodtype','$phonenumber','$email','$username','$password')";
	try{
...
<tr>
<td>Enter a Firstname *:</td>
<td><input type="text" name="firstname" placeholder="enter your firstname" required></td>
</tr>
<tr>
<td>Enter a Lastname *:</td>
<td><input type="text" name="lastname" placeholder="enter your lastname" required></td>
</tr>
<tr>
<td>Enter Area</td>
